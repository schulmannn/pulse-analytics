...
const { NON_REVENUE_STATUSES, ORDER_STATUSES } = require('../domain/cdekImport');
 ...
 */
// Нормализация фильтров переехала в domain/cdekFilters: это правила разбора запроса, а не
// доступ к данным, и роуту они нужны так же, как репозиторию (см. гвард границ).
const {
  SALES_CHANNEL_KEYS,
  ORDER_CHANNEL_KEYS,
  INCLUDE_MODES,
