...
/* ── Rusender: учётка источника, архив рассылок и дневная активность (миграция 039) ─────────────
   ...
   ЗАМЕР НА ЖИВЫХ ДАННЫХ подтвердил, что расхождение реально и системно, а не гипотетично: у
   рассылки 108243 сумма дневного ряда — 128 открытий и 12 кликов, а её итоги — 134 и 13. Окно
   активности у Rusender ограничено (в замере ~11 дней от отправки), и длинный хвост открытий
   попадает только в кумулятивные итоги. «Дотягивать» ряд до итогов НЕЛЬЗЯ: ряд честно отвечает
   на вопрос «когда читали», итоги — «сколько всего прочитали».
