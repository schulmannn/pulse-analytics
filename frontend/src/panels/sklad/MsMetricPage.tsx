...
function MsFunnelPage() {
  ...
  return (
    <MsMetricShell
      back={BACK_OVERVIEW}
      term="Воронка статусов"
      descriptor="Заказы окна по статусам МойСклада"
      about={{
        formula: 'Заказы окна, сгруппированные по статусу МойСклада; переключатель — по числу заказов или по выручке.',
