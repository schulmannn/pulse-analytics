...
export function Breakdown({ items }: BreakdownProps) {
  ...
  // ShareRows/ShareTrack, где доля обязательна. Заливка здесь идёт ПОД всей строкой, и на долях
  // она перестаёт быть мерой: проверено на этой же карточке — при семи днях недели (7…19% каждый)
  ...
  // утверждение, просто другое; где вопрос именно в доле, её называет сам `display`
  // (см. поток подписчиков в TgAnalytics: «1.2k · 40%»).
