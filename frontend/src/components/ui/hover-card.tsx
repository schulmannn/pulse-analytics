  ...
  <HoverCardPrimitive.Portal>
    <HoverCardPrimitive.Content
      ...
      className={cn(
        ...
        'data-[state=open]:animate-in data-[state=open]:ease-house data-[state=closed]:animate-out data-[state=closed]:ease-exit data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 motion-reduce:duration-0 origin-(--radix-hover-card-content-transform-origin)',
        className,
      )}
      {...props}
    />
