...
const PATHS = {
  ...
  // Мегафон — «Кампании» (второе представление раздела «Контент»); в сете это единственный глиф
  // про продвижение, у «Контента» остаётся список-строк.
  campaigns: ['m3 11 18-5v12L3 14v-3z', 'M11.6 16.8a3 3 0 1 1-5.8-1.6'],
  ...
  // Bell — «Уведомления» (личная подписка на упоминания).
  ...
  // Палитра — вход в студию оформления из меню аккаунта.
  palette: [
    'M12 21a9 9 0 1 1 0-18c4.97 0 9 3.58 9 8 0 2.21-1.79 4-4 4h-1.6a1.4 1.4 0 0 0-1 2.4c.26.26.4.62.4 1a1.6 1.6 0 0 1-1.6 1.6H12z',
    'M7.5 13.5h.01',
    'M8.5 9.5h.01',
    'M12 7.5h.01',
    'M15.5 9.5h.01',
  ...
  // Стопка кадров — «Альбом»/карусель Instagram: у `image` нет способа сказать «их несколько»,
  // а словом формат уже назван в соседней колонке.
  carousel: ['M8 3h12a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z', 'M4 7v13a1 1 0 0 0 1 1h13'],
  upload: ['M12 16V4', 'm7 9 5-5 5 5', 'M4 16v3a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-3'],
  // «Рассылки» Rusender — конверт: контент-единица источника это письмо, а не пост.
