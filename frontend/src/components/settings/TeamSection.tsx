          ...
          <>
            ...
            {shownLink && (
              <div className="mt-3">
                ...
                />
                {/* Показанная ссылка перестаёт быть доказательством владения ящиком: по ней
                    аккаунт заводится неактивным и активируется письмом на сам адрес (H-1). */}
                <p className="mt-2 text-xs text-ink2">
                  По этой ссылке аккаунт активируется только после подтверждения почты — пароль
                  задаёт владелец адреса.
                </p>
              </div>
            )}
          </>
