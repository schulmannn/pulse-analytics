 ...
 *
 * До этого компонента строка классов была скопирована в четыре места (тела карточек и шапка
 * оверлея разворота), и копии успели разойтись: канон давно чинил line-box на `leading-[1.15]`
