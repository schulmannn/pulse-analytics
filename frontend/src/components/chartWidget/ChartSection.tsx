      ...
      <div
        className={`${
          props.strip
            ...
            : `flex flex-col ${SIZE_HEIGHT[effectiveSize]} rounded-lg border bg-card p-4 shadow-[0_12px_32px_-30px_rgba(0,0,0,0.9)] sm:p-5 transition-colors hover:border-ink3/40 hover:[--card-tint-alpha:0.16] dark:hover:border-white/[0.12] dark:hover:[--card-tint-alpha:0.18]`
        } ${
