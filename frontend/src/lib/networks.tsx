...
export const NETWORKS = [
  ...
  },
  {
    ...
    nav: [
      ...
      // «Каналы» — источники продаж (сайт/директ/маркетплейс/самовывоз) + география заказов.
      { to: '/sklad/channels', label: 'Каналы', icon: 'charts' },
    ],
  ...
  },
  {
    ...
    nav: [
      ...
      { to: '/rusender/campaigns', label: 'Рассылки', icon: 'mail' },
      // «База» — контакты и списки: аудитория этого источника.
      { to: '/rusender/audience', label: 'База', icon: 'audience' },
    ],
...
export function routeNetworkOwner(pathname: string): Network | null {
  ...
  if (pathname.startsWith('/metrics/')) {
    const key = pathname.slice('/metrics/'.length);
