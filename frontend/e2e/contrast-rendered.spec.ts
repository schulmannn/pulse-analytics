...
const ROUTES = [
  ...
  '/reports',
  '/instagram',
  // Демография: четыре разреза, у каждого своя мелкая подпись (шапка колонок, доля, ранг,
  // примечание об охвате). Маршрут добавлен вместе с примечанием — мелкий приглушённый текст
  // сюда и приходит, и мерить его надо там же, где он живёт.
  '/instagram/audience',
  '/sklad',
  '/metrics/views',
  '/metrics/subscribers',
